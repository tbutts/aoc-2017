...
You can 't control the  speed of the packet  , but you can _delay_ it any
number of picoseconds. For each picosecond you delay the packet before
beginning your trip, all security scanners move one step. You 're not in the
firewall during this time; you don't enter layer ` 0 ` until you stop delaying
the packet.
...
_What is the fewest number of picoseconds_ that you need to delay the packet
